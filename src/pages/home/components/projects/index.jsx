...
export const Projects = () => {
  return (
    <section className="px-6 mb-[120px] md:px-10 xl:max-w-[1111px] xl:mx-auto xl:p-0">
      <div className="grid grid-cols-1 grid-rows-[250px_250px_250px] lg:grid-cols-[1fr_1fr] lg:grid-rows-[308px_308px] gap-6">
